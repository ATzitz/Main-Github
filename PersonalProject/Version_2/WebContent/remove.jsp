...
<head>
  ...
  <title>BooKcamp: Delete Account</title>
...
<%@include file="navbar.jsp" %>
 ...
 <div class="row" style="margin-left: 2%; margin-right: 2%;">
	<%@include file="genres.jsp"%>
      ...
      <h3 align=center style="color:white">Please give your password</h3>
      	
      	<!-- Main Form -->
      	<div class="login-form-1" align=left>
      		<form id="login-form" class="text-left" action="removeresult.jsp" method="post">
      			...
      			<div class="main-login-form">
      				...
      				<button type="submit" class="login-button"><img src="arrow.jpg" width=20 height=20></button>
      			</div>
      		</form>
      	</div>
      	<!-- end:Main Form -->
