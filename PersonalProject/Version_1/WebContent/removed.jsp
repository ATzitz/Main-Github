...
<body>
				...
				<form class="navbar-form navbar-search" role="search" method="get"
					...
					<select id="rating" name="rating" type="select"
						...
						<ul class="dropdown-menu pull-left" role="menu">
							...
							<li>
								<option value="AND rating.rating>1"><span
										class="glyphicon glyphicon-book"></span> <span
										class="label-icon">1 Star</span>
								</option>
							</li>
							<li>
								<option value="AND rating.rating>2"><span
										class="glyphicon glyphicon-folder-open"></span> <span class=se"label-icon">2
										Stars</span>
								</option>
							</li>
							<li>
								<option value="AND rating.rating>3"><span
										class="glyphicon glyphicon-user"></span> <span
										class="label-icon">3 Stars</span>
								</option>
							</li>
							<li>
								<option value="AND rating.rating>4"><span
										class="glyphicon glyphicon-user"></span> <span
										class="label-icon">4 Stars</span>
								</option>
							</li>
							<li>
								<option value="AND rating.rating>5"><span
										class="glyphicon glyphicon-user"></span> <span
	...
	<%  String bookimagerem = (String) request.getAttribute("removedbook");%>

	<div class="container">

		<article class="search-result row">
			<div class="col-xs-12 col-sm-12 col-md-3">
				<a href="#" title="<%=bookimagerem%>" class="thumbnail"><img
					src="<%=bookimagerem%>" /> </a>
			</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-7 excerpet">
				<br> <br> <br>
				<h3>
					<a href="#" title=""></a>This awful book no longer exists in your
					wishlist!
				</h3>
