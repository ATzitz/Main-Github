...
<body>
		...
		<div class="collapse navbar-collapse"
			...
			<form class="navbar-form navbar-search" role="search" method="get"
				...
				<div class="input-group">
							...
							<ul class="dropdown-menu pull-left" role="menu">
								...
								<li>
									<option value="book.category"><span
											...
											class=se"label-icon">Search By Category</span>
									</option>
								</li>
								<li>
					...
					<input type="text" name="searchfield" class="form-control" size=40%
						placeholder="Search by Book Title, Category or Author">
	...
	<div class="col-sm-12" align=center>
		...
		<table align=center width=60%>
			<tr>
				<td align=center width=20%><a href="error.jsp">Sample error
						page</a>
			...
			<tr>
				<td></td>
				<td align=center width=60%><img src="favicon.ico"> © 2015
					<a href="index.jsp">Bookcamp.we.rock</a>. All rights reserved.</td>
			</tr>
		</table>
